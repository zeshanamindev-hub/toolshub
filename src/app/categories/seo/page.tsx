...
export const metadata = {
  ...
  description: `${category.description}. Access ${categoryTools.length} essential SEO tools including meta tag preview, sitemap generator, and keyword analysis. All tools are free and work instantly in your browser.`,
  keywords: "SEO tools, meta tags, sitemap generator, keyword density, robots.txt, Open Graph, UTM links, favicon generator, heading extractor, broken link checker"
}
        ...
        <div className="mb-12">
          ...
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
              {category.description}. Browse our collection of {categoryTools.length} essential utilities for search engine optimization and website analysis.
            </p>
