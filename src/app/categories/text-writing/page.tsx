...
const category = CATEGORIES["text-writing"]
...
export const metadata = {
  ...
  description: `${category.description}. Access ${categoryTools.length} professional text processing tools including word counter, character counter, case converter, and more. All tools are free and work instantly in your browser.`,
  keywords: "text tools, word counter, character counter, case converter, text processing, free online tools"
}

export default function TextWritingCategoryPage() {
  return (
        ...
        <div className="mb-12">
          ...
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
              {category.description}. Browse our collection of {categoryTools.length} powerful text processing utilities.
            </p>
