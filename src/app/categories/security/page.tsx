...
export const metadata = {
  ...
  description: `${category.description}. Access ${categoryTools.length} professional security and hash tools including MD5, SHA-1, SHA-256 generators. All tools are free and work instantly in your browser.`,
  keywords: "security tools, hash generator, MD5, SHA-1, SHA-256, encryption, free online tools"
}
        ...
        <div className="mb-12">
          ...
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
              {category.description}. Browse our collection of {categoryTools.length} professional security and encryption utilities.
            </p>
