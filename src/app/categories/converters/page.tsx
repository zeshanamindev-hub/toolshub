...
const category = CATEGORIES["converters"]
...
export const metadata = {
  ...
  description: `${category.description}. Access ${categoryTools.length} professional conversion tools including URL encoding, Base64 conversion, JSON formatting, and more. All tools are free and work instantly in your browser.`,
  keywords: "converters, encoding, URL encoder, Base64 converter, JSON formatter, ASCII converter, free online tools"
}
        ...
        <div className="mb-12">
          ...
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
              {category.description}. Browse our collection of {categoryTools.length} powerful conversion and encoding utilities.
            </p>
