        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/80 backdrop-blur-sm border border-gray-200 mb-4">
              ...
              <span className="text-sm font-semibold text-gray-700">ASCII Decoder</span>
            </div>
              ...
              <div className="bg-white rounded-2xl p-4 border border-gray-200">
                ...
                <div className="space-y-2 text-xs">
                  <div className="flex justify-between py-1.5 border-b border-gray-100">
                    <span className="font-semibold text-gray-700">0-31</span>
                    <span className="text-gray-500">Control</span>
                  </div>
                  <div className="flex justify-between py-1.5 border-b border-gray-100">
                    <span className="font-semibold text-gray-700">32-47</span>
                    <span className="text-gray-500">Symbols</span>
                  </div>
                  <div className="flex justify-between py-1.5 border-b border-gray-100">
                    <span className="font-semibold text-gray-700">48-57</span>
                    <span className="text-gray-500">Digits 0-9</span>
                  </div>
                  <div className="flex justify-between py-1.5 border-b border-gray-100">
                    <span className="font-semibold text-gray-700">65-90</span>
                    <span className="text-gray-500">A-Z</span>
                  </div>
                  <div className="flex justify-between py-1.5 border-b border-gray-100">
                    <span className="font-semibold text-gray-700">97-122</span>
                    <span className="text-gray-500">a-z</span>
                  </div>
                  <div className="flex justify-between py-1.5">
                    <span className="font-semibold text-gray-700">128-255</span>
              ...
              <div className="bg-white rounded-2xl p-6 border border-gray-200">
                ...
                <div className="space-y-3 pt-4 border-t border-gray-200">
                  <label className="flex items-center gap-3 cursor-pointer">
                    ...
                    />
                    <div>
                      <span className="text-sm font-semibold text-gray-900">Unicode Support</span>
                  ...
                  <label className="flex items-center gap-3 cursor-pointer">
                    ...
                    />
                    <div>
                      <span className="text-sm font-semibold text-gray-900">Show Control Characters</span>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
                    {[
                      ...
                      <div key={i} className="bg-gray-50 border border-gray-200 rounded-lg p-3 text-center">
                        <div className={`text-xl font-black text-${stat.color}-600`}>{stat.value}</div>
